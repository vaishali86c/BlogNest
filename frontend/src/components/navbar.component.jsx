      ...
      <nav className="border-b border-zinc-200 px-4 py-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex shrink-0 items-center gap-1 sm:gap-2">
            ...
            <Link
              to="/signup"
              className="flex h-10 items-center rounded-full bg-zinc-950 px-3 text-sm font-semibold text-white hover:bg-zinc-800 sm:px-4"
            >
              Sign up
            </Link>
            <Link
              to="/signin"
              className="flex h-10 items-center rounded-full px-3 text-sm font-semibold text-zinc-700 hover:bg-zinc-100 sm:px-4"
            >
              Sign in
            </Link>
          </div>
